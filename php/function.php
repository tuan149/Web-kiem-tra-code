<?php
    ...
    function _ExecuteOnline($code, $input = "", $lng = 'c') {
        ...
        $lng_to_number = array('cpp14' => 44, 'c' => 11, 'cpp' => 1, 'csharp' => 27, 'pascal' => 22, 'java' => 10); // đổi ra số
    ...
    function get_fcontent( $url, $ch, $ckfile = "", $data_post = "", $javascript_loop = 0, $timeout = 5, $header = null ) {
